...
<body>
        ...
        <div class="table w-full bg-gradient-to-r from-purple-500 to-pink-500">
   <div class="table-header-group">
    <div class="table-row">
    <div class=" ml-64 p-2 mt-5 grid grid-rows-6 grid-flow-col">
    <div class="row-start-1 col-start-2"> 
    <table class="mt-16 table-fixed w-full bg-white border-solid border-8 border-green-400 text-xl text-center rounded shadow-md hover:bg-sky-50">
        <tr class="border-solid border-8 border-green-400">
            <th class="border-solid border-2 border-green-400">ID</th>
            <th class="border-solid border-2 border-green-400">Name</th>
            <th class="border-solid border-2 border-green-400">Email</th>
        </tr>
      </div>
      </div>
      </div>
